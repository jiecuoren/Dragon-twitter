...
Item {
    ...
    onVisibleChanged: {
        console.log("tab profile favorites visible changed");

        if (visible && (0 === tweetsList.model.count))
        {
            _screenName = viewmanager.getView(application.kUserProfileView, false).userInfo.screen_name
    ...
    Component.onCompleted: {
        ...
        var getTweetsApi = Qt.createComponent("../apis/ApiFavorites.qml").createObject(tweetsList);
